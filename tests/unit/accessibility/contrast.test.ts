...
function makeExporterPairs(exporterColor: Resolve): Pair[] {
  ...
  return [
    ...
    {
      label: 'artifacts-section h2 on user (tinted) bg',
      fg: exporterColor('.artifacts-section h2 {', 'color'),
      bg: userMsgBg,
      threshold: 4.5,
    },
    {
      label: 'artifacts-section h2 on assistant (page) bg',
      fg: exporterColor('.artifacts-section h2 {', 'color'),
      bg: assistantMsgBg,
      threshold: 4.5,
    },
    {
      label: 'web-searches-section h2 on user (tinted) bg',
      fg: exporterColor('.web-searches-section h2 {', 'color'),
      bg: userMsgBg,
      threshold: 4.5,
    },
    {
      label: 'web-searches-section h2 on assistant (page) bg',
      fg: exporterColor('.web-searches-section h2 {', 'color'),
      bg: assistantMsgBg,
      threshold: 4.5,
    },
    {
      label: 'artifact h3 (default bg)',
      fg: exporterColor('.artifact h3 {', 'color'),
      bg: artifactBg,
      threshold: 4.5,
    },
    {
      label: 'artifact h3 (user-message bg)',
      fg: exporterColor('.artifact h3 {', 'color'),
      bg: artifactUserBg,
      threshold: 4.5,
    },
    ...
    {
      label: 'web-search h3 on user (tinted) bg',
      fg: exporterColor('.web-search h3 {', 'color'),
      bg: userMsgBg,
      threshold: 4.5,
    },
    {
      label: 'web-search h3 on assistant (page) bg',
      fg: exporterColor('.web-search h3 {', 'color'),
      bg: assistantMsgBg,
      threshold: 4.5,
    },
